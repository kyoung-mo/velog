...
<hr />
<h3 id="소유권-관리-chown-chgrp">소유권 관리 (chown, chgrp)</h3>
<ul>
...
<h3 id="1-사용자-정보--주-그룹-gid-확인-etcpasswd">1. 사용자 정보 &amp; 주 그룹 (GID) 확인: <code>/etc/passwd</code></h3>
...
<h3 id="2-그룹-상세--보조-그룹-확인-etcgroup">2. 그룹 상세 &amp; 보조 그룹 확인: <code>/etc/group</code></h3>
